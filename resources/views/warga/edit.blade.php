...
<head>
    ...
    <title>Edit Warga — Nagari Koto Kaciak Barat</title>
    <meta name="description" content="Edit data warga" />
            ...
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="mb-8">
                    <div class="flex items-center gap-4 mb-4">
                        <a href="{{ route('warga.show', $warga) }}" class="text-slate-600 hover:text-emerald-700 transition">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                            </svg>
                        </a>
                        <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Edit Data Warga</h1>
                    </div>
                    <p class="text-slate-600">Edit data warga: <strong>{{ $warga->nama_lengkap }}</strong></p>
                </div>
                ...
                <form method="POST" action="{{ route('warga.update', $warga) }}" class="space-y-6">
                    ...
                    <div class="form-section bg-white rounded-2xl border border-slate-200 p-6">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="nama_lengkap" required value="{{ old('nama_lengkap', $warga->nama_lengkap) }}" placeholder="Nama lengkap sesuai KTP" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                @error('nama_lengkap')
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_panggilan" value="{{ old('nama_panggilan', $warga->nama_panggilan) }}" placeholder="Nama sehari-hari" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                            ...
                            <div>
                                ...
                                <input type="text" name="tempat_lahir" required value="{{ old('tempat_lahir', $warga->tempat_lahir) }}" placeholder="Kota kelahiran" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                @error('tempat_lahir')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="date" name="tanggal_lahir" required value="{{ old('tanggal_lahir', $warga->tanggal_lahir ? $warga->tanggal_lahir->format('Y-m-d') : '') }}" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                @error('tanggal_lahir')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select name="hubungan_keluarga" required class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none">
                                    ...
                                    <option value="Kepala Keluarga" {{ $warga->hubungan_keluarga == 'Kepala Keluarga' ? 'selected' : '' }}>Kepala Keluarga</option>
                                    <option value="Istri" {{ $warga->hubungan_keluarga == 'Istri' ? 'selected' : '' }}>Istri</option>
                                    <option value="Anak" {{ $warga->hubungan_keluarga == 'Anak' ? 'selected' : '' }}>Anak</option>
                                    <option value="Orang Tua" {{ $warga->hubungan_keluarga == 'Orang Tua' ? 'selected' : '' }}>Orang Tua</option>
                                    <option value="Cucu" {{ $warga->hubungan_keluarga == 'Cucu' ? 'selected' : '' }}>Cucu</option>
                                    <option value="Famili Lain" {{ $warga->hubungan_keluarga == 'Famili Lain' ? 'selected' : '' }}>Famili Lain</option>
                                    <option value="Lainnya" {{ $warga->hubungan_keluarga == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_ayah_kandung" value="{{ old('nama_ayah_kandung', $warga->nama_ayah_kandung) }}" placeholder="Nama ayah kandung" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_ibu_kandung" value="{{ old('nama_ibu_kandung', $warga->nama_ibu_kandung) }}" placeholder="Nama ibu kandung" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                    ...
                    <div class="form-section bg-white rounded-2xl border border-slate-200 p-6">
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <textarea name="alamat_lengkap" required rows="3" placeholder="Alamat lengkap tempat tinggal" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none">{{ old('alamat_lengkap', $warga->alamat_lengkap) }}</textarea>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" name="kelurahan" value="{{ old('kelurahan', $warga->kelurahan) }}" placeholder="Kelurahan/Desa" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                    @error('kelurahan')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="kecamatan" value="{{ old('kecamatan', $warga->kecamatan) }}" placeholder="Kecamatan" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                    @error('kecamatan')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="kabupaten" value="{{ old('kabupaten', $warga->kabupaten) }}" placeholder="Kabupaten/Kota" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                    @error('kabupaten')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="provinsi" value="{{ old('provinsi', $warga->provinsi) }}" placeholder="Provinsi" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                    @error('provinsi')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="sesuai_kk" value="1" {{ $warga->sesuai_kk ? 'checked' : '' }} class="rounded border-slate-300 text-emerald-600 focus:ring-emerald-500" />
                    ...
                    <div class="form-section bg-white rounded-2xl border border-slate-200 p-6">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <select name="pekerjaan" required id="pekerjaan" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none">
                                    ...
                                    @foreach(App\Models\Warga::getPekerjaanOptions() as $key => $value)
                                        <option value="{{ $key }}" {{ $warga->pekerjaan == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                                @error('pekerjaan')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div id="pekerjaan_lain_container" class="conditional-field {{ $warga->pekerjaan == 'Lainnya' ? 'show' : '' }}">
                                <label class="block text-sm font-medium text-slate-700 mb-2">Pekerjaan Lain</label>
                                <input type="text" name="pekerjaan_lain" value="{{ old('pekerjaan_lain', $warga->pekerjaan_lain) }}" placeholder="Jelaskan pekerjaan lain" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                    ...
                    <div class="form-section bg-white rounded-2xl border border-slate-200 p-6">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <select name="tingkat_pendidikan" required id="pendidikan" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none">
                                    ...
                                    @foreach(App\Models\Warga::getPendidikanOptions() as $key => $value)
                                        <option value="{{ $key }}" {{ $warga->tingkat_pendidikan == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div id="pendidikan_lain_container" class="conditional-field {{ $warga->tingkat_pendidikan == 'Lainnya' ? 'show' : '' }}">
                                <label class="block text-sm font-medium text-slate-700 mb-2">Pendidikan Lain</label>
                                <input type="text" name="pendidikan_lain" value="{{ old('pendidikan_lain', $warga->pendidikan_lain) }}" placeholder="Jelaskan pendidikan lain" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                    ...
                    <div class="form-section bg-white rounded-2xl border border-slate-200 p-6">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="no_paspor" value="{{ old('no_paspor', $warga->no_paspor) }}" placeholder="Nomor paspor" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                @error('no_paspor')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="no_kitap" value="{{ old('no_kitap', $warga->no_kitap) }}" placeholder="Nomor KITAP" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                @error('no_kitap')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="ayah_nik" value="{{ old('ayah_nik', $warga->ayah_nik) }}" placeholder="NIK ayah" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                @error('ayah_nik')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="ibu_nik" value="{{ old('ibu_nik', $warga->ibu_nik) }}" placeholder="NIK ibu" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                @error('ibu_nik')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="is_wafat" value="1" id="is_wafat" {{ $warga->is_wafat ? 'checked' : '' }} class="rounded border-slate-300 text-emerald-600 focus:ring-emerald-500" />
                                    <span class="text-sm text-slate-700">Warga sudah wafat</span>
                                </label>
                            </div>
                            <div id="tanggal_wafat_container" class="conditional-field sm:col-span-2 {{ $warga->is_wafat ? 'show' : '' }}">
                                <label class="block text-sm font-medium text-slate-700 mb-2">Tanggal Wafat</label>
                                <input type="date" name="tanggal_wafat" id="tanggal_wafat" value="{{ old('tanggal_wafat', $warga->tanggal_wafat ? $warga->tanggal_wafat->format('Y-m-d') : '') }}" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none" />
                                @error('tanggal_wafat')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="catatan" rows="3" placeholder="Catatan tambahan" class="form-input w-full rounded-lg border border-slate-300 px-4 py-2 outline-none">{{ old('catatan', $warga->catatan) }}</textarea>
                                @error('catatan')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="flex items-center justify-end gap-4">
                        <a href="{{ route('warga.show', $warga) }}" class="px-6 py-3 rounded-full border border-slate-300 text-slate-700 font-medium hover:bg-slate-50 transition">
                            Batal
                        </a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (pekerjaan.value === 'Lainnya') {
                document.getElementById('pekerjaan_lain_container').classList.add('show');
            }

            const pendidikan = document.getElementById('pendidikan');
            if (pendidikan.value === 'Lainnya') {
                document.getElementById('pendidikan_lain_container').classList.add('show');
            }

            const isWafat = document.getElementById('is_wafat');
            if (isWafat.checked) {
                document.getElementById('tanggal_wafat_container').classList.add('show');
            }
        });
    </script>
</body>
