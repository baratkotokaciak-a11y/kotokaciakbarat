...
<head>
    ...
    <title>Tambah Jorong — Nagari Koto Kaciak Barat</title>
            ...
            <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
                <div class="mb-8">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Tambah Jorong</h1>
                    </div>
                    <p class="text-slate-600">Tambahkan jorong baru di Nagari Koto Kaciak Barat</p>
                </div>

                <form method="POST" action="{{ route('jorong.store') }}" class="bg-white rounded-2xl border border-slate-200 p-6">
                    @csrf

                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-2">Nama Jorong <span class="text-red-500">*</span></label>
                            <input type="text" name="nama_jorong" required placeholder="Nama jorong" class="w-full rounded-lg border border-slate-300 px-4 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition" />
                            @error('nama_jorong')
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="3" placeholder="Deskripsi jorong" class="w-full rounded-lg border border-slate-300 px-4 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition"></textarea>
                            @error('deskripsi')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="nik_ketua_jorong" maxlength="16" placeholder="NIK ketua jorong" class="w-full rounded-lg border border-slate-300 px-4 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition" />
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_ketua_jorong" placeholder="Nama ketua jorong" class="w-full rounded-lg border border-slate-300 px-4 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition" />
