...
<head>
    ...
    <title>Tambah Kartu Keluarga — Nagari Koto Kaciak Barat</title>
        ...
        <main>
            <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
                <div class="mb-8">
                    ...
                    <p class="text-slate-600">Tambahkan kartu keluarga baru di Nagari Koto Kaciak Barat</p>
                </div>

                <form method="POST" action="{{ route('kartu-keluarga.store') }}" class="bg-white rounded-2xl border border-slate-200 p-6">
                    @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="kepala_keluarga" required placeholder="Nama kepala keluarga" class="w-full rounded-lg border border-slate-300 px-4 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition" />
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="telepon" placeholder="Nomor telepon" class="w-full rounded-lg border border-slate-300 px-4 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition" />
                                @error('telepon')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
